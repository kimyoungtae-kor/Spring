       ...
       <jsp:include page="../common/header.jsp"></jsp:include>
        <main class="container">
            ...
            <form name = "frm"class="mx-auto col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 card p-2 mt-5" method="post">
                <input type="text" class="form-control my-3" id="id" placeholder="아이디" name="id" value="${cookie['save'].value}">
                <input type="password" class="form-control my-3" id="pwd" placeholder="비밀번호" name="pwd">
                <div class="form-check form-switch my-3">
                    <input class="form-check-input" type="checkbox" id="mySwitch" name="remember-id" value="yes" ${empty cookie['save'] ? '' : 'checked'}>
