...
import shop.youngatae.guestbook.domain.entity.QBoard;
import shop.youngatae.guestbook.domain.entity.QMember;
import shop.youngatae.guestbook.domain.entity.QReply;
...
public class SearchBoardRepositoryImpl extends QuerydslRepositorySupport implements SearchBoardRepository{
  ...
  @Override
  public Page<Object[]> searPage(String type, String keyword, Pageable pageable) {
    QBoard board = QBoard.board;
    QReply reply = QReply.reply;
    QMember member = QMember.member;
